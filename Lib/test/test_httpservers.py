...
class CGIHTTPServerTestCase(BaseTestCase):
    ...
    @unittest.expectedFailureIf(sys.platform != 'wind32', "TODO: RUSTPYTHON; AssertionError: b'' != b'32768 32768\n'")
    ...
    @unittest.expectedFailureIf(sys.platform != 'wind32', "TODO: RUSTPYTHON; AssertionError: b'' != b'Hello World\n'")
