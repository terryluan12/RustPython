...
# TODO: RUSTPYTHON;
class ProcessPoolForkWaitTest(ProcessPoolForkWaitTest):
    @unittest.skipIf(sys.platform == 'linux', 'TODO: RUSTPYTHON; flaky')
    def test_first_completed(self): super().test_first_completed()
    @unittest.skipIf(sys.platform == 'linux', 'TODO: RUSTPYTHON; Fatal Python error: Segmentation fault')
    def test_first_completed_some_already_completed(self): super().test_first_completed_some_already_completed()
    @unittest.skipIf(sys.platform == 'linux', 'TODO: RUSTPYTHON; flaky')
    def test_first_exception(self): super().test_first_exception()
    @unittest.skipIf(sys.platform == 'linux', 'TODO: RUSTPYTHON; flaky')
    def test_first_exception_one_already_failed(self): super().test_first_exception_one_already_failed()
    @unittest.skipIf(sys.platform == 'linux', 'TODO: RUSTPYTHON; Fatal Python error: Segmentation fault')
    def test_first_exception_some_already_complete(self): super().test_first_exception_some_already_complete()
    @unittest.skipIf(sys.platform == 'linux', 'TODO: RUSTPYTHON; Fatal Python error: Segmentation fault')
    def test_timeout(self): super().test_timeout()
# END RUSTPYTHON;
# ----------------------------------------------------------------------------------------------
